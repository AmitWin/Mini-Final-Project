...
class Ui_MainWindow(QMainWindow):
    ...
    def openCheckers(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = Ui_CheckersOptions()
        self.ui.setupUi(self.window)
        self.window.show()
        self.LogInPage.close()
...
"")
    ...
    def log_in(self):
        ...
        if self.Is_User_Exists(username, password):
            ...
            self.UserWasNotFoundPopUp()

    def UserWasNotFoundPopUp(self):
        msg = QMessageBox()
        msg.setWindowTitle("User was not found")
        msg.setText("Your username or password were incorrect.")
...
class Ui_CheckersOptions(object):
    def setupUi(self, CheckersOptions):
        ...
        CheckersOptions.setObjectName("CheckersOptions")
        CheckersOptions.resize(600, 400)
        CheckersOptions.setStyleSheet("background-color:black;")
        self.centralwidget = QtWidgets.QWidget(CheckersOptions)
        self.centralwidget.setObjectName("centralwidget")
...
"border-color:black;")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 600, 21))
        self.menubar.setObjectName("menubar")
        CheckersOptions.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(CheckersOptions)
        self.statusbar.setObjectName("statusbar")
    ...
    def retranslateUi(self, CheckersOptions):
        ...
        self.MainLabel.setText(_translate("CheckersOptions", "Checkers Options"))
        self.PlayVSComputer.setText(_translate("CheckersOptions", "Play VS. computer"))
